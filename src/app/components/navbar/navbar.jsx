    ...
    return(
        ...
        <div className={styles.navbar}>
            <div className={styles.navbarContainer}>
                ...
                <a href="/gymbuddy/workout" className={styles.navbarButton}><img src="/gymbuddy/logWorkout.png"className={styles.navbarImg}/><p>work out</p></a>
                <a href="/gymbuddy/protein" className={styles.navbarButton}><img src="/gymbuddy/logProtein.png"className={styles.navbarImg}/><p>log</p></a>
